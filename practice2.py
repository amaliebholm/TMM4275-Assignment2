...
pointlist = np.array([[0,0,0],[0,10,0],[-2,12,0],[-10,12,0],[-11,11,0],[-12,8,0]])
...
for i in range(len(pointlist)-1):
    ...
    #arcs
        ...
        rail = add_arc(i,r,angle_in,angle_out,xcenter,ycenter,pointlist[i][2],rail)
    else:
        print("Neither arc or line?")

    if i != (len(pointlist)-1): #Making the string that says what parts to curve_join
